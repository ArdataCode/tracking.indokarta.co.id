                        ...
                        <div class="elementor-widget-wrap elementor-element-populated">
                            ...
                            >
                                <div class="elementor-widget-container">
                                    ...
                                    <form class="form" method="post" name="checkRate" id="checkRate" action="{{route('check-rate-submit')}}">
                                        ...
                                        <div class="elementor-form-fields-wrapper elementor-labels-">
                                            <div class="elementor-field-type-text elementor-field-group elementor-column elementor-field-group elementor-col-100 elementor-field-required">
                                                ...
                                                <select class="elementor-field elementor-size-md elementor-field-textual" id="from" name="from" required="required">
                                                    ...
                                                    @foreach ($from as $f)
                                                        <option value="{{$f->from}}">{{$f->RegencyFrom->name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            ...
                                            <div class="elementor-field-type-text elementor-field-group elementor-column elementor-field-group elementor-col-100 elementor-field-required">
                                                ...
                                                <select class="elementor-field elementor-size-md elementor-field-textual" id="to" name="to" required="required">
                                                    <option value="" disabled selected>- Pilih Asal -</option>
                                                    @foreach ($to as $t)
                                                        <option value="{{$t->to}}">{{$t->RegencyTo->name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                            ...
                            <div class="elementor-element elementor-element-1ea921ef elementor-widget elementor-widget-heading" data-id="1ea921ef" data-element_type="widget" data-widget_type="heading.default">
                                <div class="elementor-widget-container">
                                    <div class="elementor-heading-title elementor-size-default" id="ratetable" style="padding:20px; font-weight: 500; margin: 0 auto;">
                                        <h5 style="color:#333; font-size:16px;">DETAIL TARIF DARI <span style="color:#FF2023;">{{$asal}}</span> KE <span style="color:#FF2023;">{{$tujuan}}</span></h5>
                                        <div class="table-responsive">
                                            ...
                                            @forelse ($rate as $d)
                                            <tr>
                                            <td style="">{{$d->ServicesType->name}}</td>
                                            <td style="">Rp {{number_format($d->price,0)}}</td>
                                            <td style="">{{$d->estimate}}</td>
                                            </tr>
                                            @empty
                                                <tr>
