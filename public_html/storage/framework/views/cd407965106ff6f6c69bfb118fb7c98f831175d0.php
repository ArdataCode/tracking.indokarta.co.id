...
} elseif ($_instance->childHasBeenRendered('gYk3Z1A')) {
    $componentId = $_instance->getRenderedChildComponentId('gYk3Z1A');
    $componentTag = $_instance->getRenderedChildComponentTagName('gYk3Z1A');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('gYk3Z1A');
} else {
    $response = \Livewire\Livewire::mount('notifications');
    $html = $response->html();
    $_instance->logRenderedChild('gYk3Z1A', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
 <?php echo $__env->renderComponent(); ?>
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
<?php /**PATH /home/1126019.cloudwaysapps.com/yjwpskvrnz/public_html/resources/views/vendor/filament/components/layouts/card.blade.php ENDPATH**/ ?>