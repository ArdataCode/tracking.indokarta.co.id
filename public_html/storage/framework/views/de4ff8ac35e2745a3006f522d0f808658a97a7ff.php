...
} elseif ($_instance->childHasBeenRendered('RVQdjZ5')) {
    $componentId = $_instance->getRenderedChildComponentId('RVQdjZ5');
    $componentTag = $_instance->getRenderedChildComponentTagName('RVQdjZ5');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('RVQdjZ5');
} else {
    $response = \Livewire\Livewire::mount('filament.core.global-search');
    $html = $response->html();
    $_instance->logRenderedChild('RVQdjZ5', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('pQnaxqb')) {
    $componentId = $_instance->getRenderedChildComponentId('pQnaxqb');
    $componentTag = $_instance->getRenderedChildComponentTagName('pQnaxqb');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('pQnaxqb');
} else {
    $response = \Livewire\Livewire::mount('filament.core.notifications');
    $html = $response->html();
    $_instance->logRenderedChild('pQnaxqb', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH /home/1126019.cloudwaysapps.com/yjwpskvrnz/public_html/resources/views/vendor/filament/components/topbar.blade.php ENDPATH**/ ?>