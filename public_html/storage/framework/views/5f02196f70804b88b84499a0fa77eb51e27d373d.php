...
} elseif ($_instance->childHasBeenRendered('LIMt2oO')) {
    $componentId = $_instance->getRenderedChildComponentId('LIMt2oO');
    $componentTag = $_instance->getRenderedChildComponentTagName('LIMt2oO');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('LIMt2oO');
} else {
    $response = \Livewire\Livewire::mount('filament.core.global-search');
    $html = $response->html();
    $_instance->logRenderedChild('LIMt2oO', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('CRRNytR')) {
    $componentId = $_instance->getRenderedChildComponentId('CRRNytR');
    $componentTag = $_instance->getRenderedChildComponentTagName('CRRNytR');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('CRRNytR');
} else {
    $response = \Livewire\Livewire::mount('filament.core.notifications');
    $html = $response->html();
    $_instance->logRenderedChild('CRRNytR', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH /home/u726706882/domains/tracking.indokarta.co.id/public_html/resources/views/vendor/filament/components/topbar.blade.php ENDPATH**/ ?>