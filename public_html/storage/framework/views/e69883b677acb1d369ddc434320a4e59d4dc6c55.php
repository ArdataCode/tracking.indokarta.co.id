                        ...
                        <div class="elementor-widget-wrap elementor-element-populated">
                            ...
                            >
                                <div class="elementor-widget-container">
                                    ...
                                    <form class="form" method="post" name="TrackingForm" id="TrackingForm" action="<?php echo e(route('track')); ?>">
  ...
  <div class="card-body">
    <div class="steps d-flex flex-wrap flex-sm-nowrap justify-content-between padding-top-2x padding-bottom-1x">
      <div class="step 
        <?php if($last == 'Pick Up'): ?>
            completed
        <?php elseif($last == 'Transit'): ?>
            completed
        <?php elseif($last == 'Delivery'): ?>
            completed
        <?php elseif($last == 'Delivered'): ?>
            completed
        <?php endif; ?>">
                        ...
                        <div class="elementor-widget-wrap elementor-element-populated">
                            ...
                            >
                                            ...
                                            <div class="elementor-element elementor-element-4834f0ad elementor-widget elementor-widget-text-editor" data-id="4834f0ad" data-element_type="widget" data-widget_type="text-editor.default">
                                                <div class="elementor-widget-container">
                                                    ...
                                                    <p>
                                                        ...
                                                        <?php if($track->receipt_date): ?>
                                                            <?php echo e($track->receipt_date); ?>
                                                    ...
                                                    <p>
                                                        ...
                                                        <?php echo e($track->KotaAsal->name); ?>

                                                    </p>
                                                    <p>
                                                        <strong>Tujuan:</strong><br />
                                                        <?php echo e($track->KotaTujuan->name); ?>

                                                    </p>
                                                    <p>
                                                        <strong>Pengirim:</strong><br />
                                                        <?php echo e($track->Customer->name); ?>

                                                    </p>
                                                    <p>
                                                        <strong>Penerima:</strong><br />
                                                        <?php echo e($track->recipient); ?>

                                                    </p>
                                                    <p>
                                                        <strong>Status:</strong><br />
                                                        <?php echo e(ucfirst($track->status)); ?>
                                                        ...
                                                        <li class="jsx-awb">
                                                            <div class="jsx-awb d-flex flex-row">
                                                                <div class="jsx-awb check-awb-details_historyDate">
                                                                    <?php if($d->date): ?>
                                                                    <p class="jsx-awb">
                                                                        <?php echo e(\Carbon\Carbon::parse($d->date)->locale('id')->dayName); ?>

                                                                    </p>
                                                                    <h5 class="jsx-awb">
                                                                        <?php echo e(\Carbon\Carbon::parse($d->date)->locale('id')->format('d M Y')); ?>

                                                                    </h5>
                                                                    <?php endif; ?>
                                                                </div>
                                                                <div class="jsx-awb check-awb-details_historyDescription">
                                                                    <p class="jsx-awb m-0"><?php echo e($d->time); ?></p>
                                                                    <p class="jsx-awb"><?php echo e($d->notes); ?></p>
                                                                </div>
                                                            </div>
                                                        </li>
                                ...
                                <div style="padding:10px;">
                                    ...
                                    <a href="/storage/<?php echo e($d->receipt_photo); ?>" target="_blank"><img src="/storage/<?php echo e($d->receipt_photo); ?>" width="200"></a>
                                </div>
                                <?php endif; ?>
...
</html><?php /**PATH /home/u726706882/domains/tracking.indokarta.co.id/public_html/resources/views/frontend/track-result.blade.php ENDPATH**/ ?>